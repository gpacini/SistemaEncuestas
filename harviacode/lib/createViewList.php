...
$string = "
        ...
        <div class=\"row\" style=\"margin-bottom: 10px\">
            <div class=\"col-md-4\">
                <?php echo anchor(site_url('".$controller."/create'),'Crear', 'class=\"btn btn-primary\"'); ?>
            </div>
...
$string .= "\n\t\t\t<td style=\"text-align:center\">"
        . "\n\t\t\t\t<?php "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/read/'.$".$controller."->".$primary."),'Ver'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/update/'.$".$controller."->".$primary."),'Actualizar'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/delete/'.$".$controller."->".$primary."),'Eliminar','onclick=\"javasciprt: return confirm(\\'Esta seguro de eliminar ?\\')\"'); "
        . "\n\t\t\t\t?>"
        . "\n\t\t\t</td>";
