        ...
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            if ($this->form_validation->run()) {        // validation ok
                if ($this->tank_auth->login(
                    ...
                    if ($this->checkRol('organizador')) {
                        redirect("programa");
                        return;
                    }
                    if ($this->checkRol('reclutamiento') || $this->checkRol('jefe_reclutamiento')) {
                        redirect('persona_cargo');
                        return;
                    }
                    if ($this->checkRol('reportes')) {
                        redirect('persona_cargo/reportes');
                        return;
                    }
            ...
            $data['pagina'] = 'paginas_publicas/login';
            $data['titulo'] = "Ingresar - Serinse S.A";
            $data['body_id'] = "paginaLogin";
            $data['contenido']['vacio'] = '';
            $this->load->view('paginas_publicas/login', $data);
        }
    }
